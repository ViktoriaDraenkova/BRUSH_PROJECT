...
class ArticlesViewAdapterP(private val clickListener: ViewHolder.OnClickListener) :
    RecyclerView.Adapter<ArticlesViewAdapterP.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bind(article: Article) {
            ...
            Glide.with(itemView).load(article.img).placeholder(R.drawable.placeholder)
