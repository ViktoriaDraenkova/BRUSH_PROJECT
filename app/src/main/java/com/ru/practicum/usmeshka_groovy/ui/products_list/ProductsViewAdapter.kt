...
import com.ru.practicum.usmeshka_groovy.util.ButtonAddClickListener
import com.ru.practicum.usmeshka_groovy.util.ButtonDelClickListener
import com.ru.practicum.usmeshka_groovy.util.ProductClickListener
...
class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(model: Product, countInCart: Long) {
        ...
        productPrice.text =
            ((model.price - model.sale).toFloat() / 100).toString() + "p/" + "${model.unitName}"
